...
#     This is important for account linking because existing profile/role/course
#     references must remain attached to the same _id.
#     """
...
#
#     Only Google-link related fields are changed. Existing password, role,
#     department, designation, employee ID, short code and _id are preserved.
#     """
#     oid = user_id if isinstance(user_id, ObjectId) else ObjectId(str(user_id))
#
#     updates = {
