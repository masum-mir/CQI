# """Business logic for individual uploaded documents (required_item based)."""
#
# import os
#
...
# # Upload Document
# # ---------------------------------------------------------------------
# def upload_document(user, cf_id, file, item_no):
...
#         raise ApiError("Forbidden", status=403)
#
#     # replace existing file for same slot
#     existing = document_repo.find_one({
#         "course_file": cf["_id"],
#         "item_no": item_no
#     })
#
#     if existing:
#         storage.remove_file(existing["file_path"])
...
# # ---------------------------------------------------------------------
# # List Documents of a Course File
# # ---------------------------------------------------------------------
# def list_documents(user, course_file_id):
#     cf = course_file_repo.find_by_id(ensure_object_id(course_file_id))
#
#     if not cf:
#         raise ApiError("Course file not found", status=404)
#
...
#     doc = _load_with_access(user, doc_id)
#
#     updated = document_repo.update(doc["_id"], {
